...
from .nodes import query_rewriter, document_reader, web_enricher, synthesizer, report_writer
...
def build_graph():
    ...
    Flow: query_rewriter → document_reader → web_enricher → synthesizer → report_writer → END
    ...
    g.add_node("planner",         query_rewriter)
